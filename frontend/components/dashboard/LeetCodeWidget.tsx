...
export default function LeetCodeWidget() {
    ...
    const fetchStats = async () => {
        ...
        try {
            ...
            const res = await fetch("http://localhost:8000/api/v1/leetcode/stats", {
    ...
    const handleLink = async () => {
        ...
        try {
            const token = localStorage.getItem("auth_token");
            const res = await fetch("http://localhost:8000/api/v1/leetcode/link", {
                method: "POST",
                headers: {
    ...
    const handleSync = async () => {
        ...
        try {
            const token = localStorage.getItem("auth_token");
            await fetch("http://localhost:8000/api/v1/leetcode/sync", {
                method: "POST",
                headers: { Authorization: `Bearer ${token}` }
            });
            await fetchStats();
